...
(package! project :pin "1539a2f9038f47bc01de987266c1b1c96671e8db" :built-in (>= emacs-major-version 30))
...
(package! llm :pin "9488a689846d03fdc773bd8d775a995796fc22aa")
...
(package! gptel :pin "c6e2339d43dc8c6d7a1ef50e8fe1e5e4b67c74ea")
(package! gptel-quick
...
(package! lsp-bridge
  :recipe (:host github
           ...
           :build (:not compile))
  :pin "942e4fab8d2183e190eeb080b978233ce7a8ce48")
(when (modulep! :checkers syntax +flymake)
